...
export class AuthConfiguration {
    ...
    authorise_url = 'https://localhost:44363/connect/authorize';
    ...
    userinfo_url = 'https://localhost:44363/connect/userinfo';

    logoutEndSession_url = 'https://localhost:44363/connect/endsession';

    checksession_url = 'https://localhost:44363/connect/checksession'
