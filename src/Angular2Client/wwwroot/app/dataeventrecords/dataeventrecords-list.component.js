System.register(['@angular/core', '@angular/common', '../services/SecurityService', '@angular/router', '../dataeventrecords/DataEventRecordsService'], function(exports_1, context_1) {
    "use strict";
